...
document.body.innerHTML = `
    ...
    <h1>PA rapido Corazón de Melón personal de Sophi🍈💖🕹️</h1>
    ...
    <div id="status"></div>
    <hr/>
    <a href="https://www.youtube.com/@HansCastroJimenez" class="button" target="_blank">📹 Fuente del codigo(YouTube) 🌐</a>
